  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved payment as @payment" do
        ...
        post :create, {:payment => { "name" => "invalid value" }}, valid_session
        expect(assigns(:payment)).to be_a_new(Payment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested payment" do
        ...
        expect_any_instance_of(Payment).to receive(:update).with({ "name" => "MyString" })
        put :update, {:id => payment.to_param, :payment => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the payment as @payment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Payment.any_instance.stub(:save).and_return(false)
        put :update, {:id => payment.to_param, :payment => { "name" => "invalid value" }}, valid_session
        expect(assigns(:payment)).to eq(payment)
      end
