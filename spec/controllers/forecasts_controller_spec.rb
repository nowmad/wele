  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved forecast as @forecast" do
        ...
        Forecast.any_instance.stub(:save).and_return(false)
        post :create, {:forecast => { "category_id" => "invalid value" }}, valid_session
        expect(assigns(:forecast)).to be_a_new(Forecast)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested forecast" do
        forecast = Forecast.create! valid_attributes
        # Assuming there are no other forecasts in the database, this
        # specifies that the Forecast created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        expect_any_instance_of(Forecast).to receive(:update).with({ "category_id" => "1" })
        put :update, {:id => forecast.to_param, :forecast => { "category_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the forecast as @forecast" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Forecast.any_instance.stub(:save).and_return(false)
        put :update, {:id => forecast.to_param, :forecast => { "category_id" => "invalid value" }}, valid_session
        expect(assigns(:forecast)).to eq(forecast)
      end
